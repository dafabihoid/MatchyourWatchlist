...
class SearchResults extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: MediaList(listWithMediaDTO: listWithMediaDTO, transferList: listWithMediaDTOWhichWillBeAdded, Icon1: Icon(null), IconType1: IconType.nichts, Icon2: Icon(Icons.add), IconType2: IconType.add)
    );
  }
